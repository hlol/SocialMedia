...
public class FindFriendsActivity extends AppCompatActivity {
    ...
    private void SearchPeopleAndFriends(String searchBoxInput)
    {
        ...
        Query searchPeopleFriendsQuery = allUsersDatabaseRef.orderByChild("fullname").startAt(searchBoxInput).endAt(searchBoxInput+ "\uf8ff");
        ...
        FirebaseRecyclerAdapter<FindFriend,FindFriendsViewHolder>firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FindFriend, FindFriendsViewHolder>
            ...
            @Override
            protected void populateViewHolder(FindFriendsViewHolder viewHolder, FindFriend model, int position) {
